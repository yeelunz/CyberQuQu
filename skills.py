...
# 狂戰
sm.add_skill(Skill(12, "狂暴之力", "對單體造成 30 點傷害，並自身反嗜15%的攻擊傷害。", 'damage'))
sm.add_skill(Skill(13, "熱血", "消耗 150 點生命值，接下來 5 回合，每回合恢復 20 點生命值。冷卻 5 回合。", 'heal',5))
sm.add_skill(Skill(14, "血怒之泉", "犧牲 30 點生命值，接下來 2 回合內免疫控制，並提升自身 35% 防禦力。", 'effect',3))
...
sm.add_skill(Skill(24, "烈焰斬擊", "對單體造成 45 點傷害，並附加 1 層燃燒狀態。", 'damage'))
sm.add_skill(Skill(25, "日冕之盾", "本回合防禦力增加 30%，並對攻擊者附加 1 層燃燒狀態，持續 1 回合。", 'effect'))
sm.add_skill(Skill(26, "陽炎爆發", "對敵方全體造成 20 點傷害，並使目標燃燒效果加倍，根據燃燒層數，每層造成5點額外傷害。", 'damage'))
...
# HuangShen (荒神) 技能定義
sm.add_skill(Skill(33, "枯骨的永恆", "對單體造成 45 點傷害，自身受到 25 點傷害。", 'damage'))
sm.add_skill(Skill(34, "荒原", "技能使用後，循環切換下次效果：\n"
