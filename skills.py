...
# 
sm.add_skill(Skill(18, "血斬", "對單體造成 25 點傷害，並疊加 1 層流血狀態。", 'damage'))
...
sm.add_skill(Skill(30, "雷霆護甲", "2 回合內，受到傷害時有 15% 機率直接麻痺敵人。", 'effect'))
sm.add_skill(Skill(31, "凍燒雷", "造成 40 點傷害，對每層麻痺、冰凍、燃燒狀態額外造成 10 點傷害。", 'damage'))
sm.add_skill(Skill(32, "雷擊術", "50% 機率使敵方暈眩 1~3 回合。", 'effect'))
