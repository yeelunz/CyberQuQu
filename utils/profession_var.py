...
MAGE_VAR = {
    ...
    'MAGE_BASE_ATK': [1.45, 1.45, 0.1, 999, 'high'],
...
ARCHER_VAR = {
    ...
    'ARCHER_BASE_ATK': [1.08, 1.08, 0.1, 999, 'high'],
    ...
    'ARCHER_SKILL_0_DAMAGE': [55, 55, 1, 999, 'high'],
    ...
    # skill 3 
    'ARCHER_SKILL_3_DAMAGE': [45, 45, 1, 999, 'high'],
...
STEADFASTWARRIOR_VAR = {
    ...
    # SKILL 3
    'STEADFASTWARRIOR_SKILL_3_DAMAGE': [25, 25, 1, 999, 'high'],
    'STEADFASTWARRIOR_SKILL_3_BONUS_DAMAGE': [15, 15, 1, 999, 'high'],  
...
DEVOUR_VAR = {
    ...
    'DEVOUR_SKILL_0_FAILURE_ADD_RATE': [0.05, 0.05, 0.01, 1, 'low'],  # 技能失敗的機率
...
ELEMENTALMAGE_VAR = {
    ...
    'ELEMENTALMAGE_SKILL_2_PARALYSIS_TRIGGER_RATE': [0.3, 0.3, 0.01, 1, 'high'],  # 暈眩觸發機率
...
HUANGSHEN_VAR = {
    ...
    'HUANGSHEN_SKILL_1_ATK_BUFF': [1.35, 1.35, 0.01, 2, 'high'],  # 攻擊力提升倍率
    'HUANGSHEN_SKILL_1_HEAL_BUFF': [1.35, 1.35, 0.01, 2, 'high'],  # 治癒力提升倍率
    'HUANGSHEN_SKILL_1_DEF_BUFF': [1.35, 1.35, 0.01, 2, 'high'],  # 防禦力提升倍率
